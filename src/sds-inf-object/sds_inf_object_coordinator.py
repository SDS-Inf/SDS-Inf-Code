...
def parse_coord_event(event):
	...
	return weights_loc, inf_data_loc, connectivity_loc, hidden_loc, metrics_loc, invoc_params, model_params
#############################################
def coord_invoke_children(weights_loc_in, inf_data_loc_in, connectivity_loc_in, hidden_loc_in, metrics_loc_in, invoc_params_in, model_params_in, js_in, bfr_in):
    bfr = bfr_in
...
def lambda_handler(event, context):
    ...
    coord_invoke_children(weights_loc, inf_data_loc, connectivity_loc, hidden_loc, metrics_loc, invoc_params, model_params, js, bfr)
